...
Public Class ShortcutPropertiesDialog
    ...
    Sub txtShortcutKey_TextChanged() Handles txtShortcutKey.TextChanged
        ...
        If isValidHotkey Then
            ...
            pbxStatus.Image = My.Resources.accept
        Else
            lblStatus.Text = "Invalid Shortcut Key"
            pbxStatus.Image = My.Resources.warning
        End If
    End Sub
    ...
    Sub btnSave_Click() Handles btnSave.Click
        ...
        Catch ex As UnauthorizedAccessException When Not WalkmanLib.IsAdmin()
            Select Case WalkmanLib.CustomMsgBox(ex.Message, Settings.GetTheme(), Operations.cMBTitle, Operations.cMBbRelaunch, Operations.cMBbRunSysTool, Operations.cMBbCancel, MessageBoxIcon.Exclamation, ownerForm:=PropertiesDotNet)
